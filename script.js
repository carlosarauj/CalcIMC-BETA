...
function btnCalc(){
    ...
    //resultado dos dados
    result.innerHTML = `Olá ${nome.value}, seu IMC é: ${imc.toFixed(2)} e você está ${imcRes} <p>(lembrando que IMC nem sempre significa se você está saudável ou não, é apenas uma base)</p>`
}
